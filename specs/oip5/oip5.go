...
func init() {
	log.Info("init oip5")
	events.SubscribeAsync("specs:oip5:msg", on5msg)
...
func on5msg(msg *pb_oip.SignedMessage, tx *datastore.TransactionData) {
	...
	if o5.Record != nil {
		...
		if err != nil {
			...
			events.Publish("specs:oip5:record", o5.Record, msg.PubKey, tx)
		}
	}
	...
	if o5.Edit != nil {
		...
		if err != nil {
			...
			events.Publish("specs:oip5:edit", o5.Record, msg.PubKey, tx)
		}
	}
